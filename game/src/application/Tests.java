...
public class Tests {
	...
	public static void main(String[] args) {
		...
		/*
		 * GameMechanics.playMove(3, 5, tab); tab.printBoard();
		 * System.out.println(GameMechanics.moves);
		 * System.out.println(GameMechanics.lines);
		 * 
		 * GameMechanics.playMove(2, 6, tab); tab.printBoard();
		 * System.out.println(GameMechanics.moves);
		 * System.out.println(GameMechanics.lines);
		 * 
		 * GameMechanics.playMove(5, 5, tab); tab.printBoard();
		 * System.out.println(GameMechanics.moves);
		 * System.out.println(GameMechanics.lines);
		 * 
		 * GameMechanics.playMove(10, 5, tab); tab.printBoard();
		 * System.out.println(GameMechanics.moves);
		 * System.out.println(GameMechanics.lines);
		 */
	}
