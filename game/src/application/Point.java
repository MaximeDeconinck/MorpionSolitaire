...
It provides a constructor for creating a point with specified x and y coordinates,
and methods for checking if two points are equal and for generating a string representation of the point.
*/
public class Point {
	...
	*/
	...
	/**
	* Returns true if the point is equal to the specified point.
